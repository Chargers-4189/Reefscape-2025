...
public class Elastic {
  ...
  public static final class ElasticAlign {
    ...
    public static DoubleEntry kDIST_FROM_REEF = alignTable
      .getDoubleTopic("DIST_FROM_REEF")
      .getEntry(Constants.AlignmentConstants.kDIST_FROM_REEF);
    public static DoubleEntry kDIST_OFFSET = alignTable
      .getDoubleTopic("DIST_OFFSET")
      .getEntry(Constants.AlignmentConstants.kDIST_OFFSET);

    public static DoubleEntry kPROPORTIONAL_X = alignTable
      .getDoubleTopic("PROPORTIONAL_X")
      .getEntry(Constants.AlignmentConstants.kPROPORTIONAL_X);
    public static DoubleEntry kPROPORTIONAL_Y = alignTable
      .getDoubleTopic("POPORTIONAL_Y")
      .getEntry(Constants.AlignmentConstants.kPROPORTIONAL_Y);
    public static DoubleEntry kPROPORTIONAL_ANGLE = alignTable
      .getDoubleTopic("POPORTIONAL_ANGLE")
      .getEntry(Constants.AlignmentConstants.kPROPORTIONAL_ANGLE);

    public static DoubleEntry kMAX_SPEED_X = alignTable
      .getDoubleTopic("MAX_SPEED_X")
      .getEntry(Constants.AlignmentConstants.kMAX_SPEED_X);
    public static DoubleEntry kMAX_SPEED_Y = alignTable
      .getDoubleTopic("MAX_SPEED_Y")
      .getEntry(Constants.AlignmentConstants.kMAX_SPEED_Y);
    public static DoubleEntry kMAX_SPEED_ANGLE = alignTable
      .getDoubleTopic("MAX_SPEED_ANGLE")
      .getEntry(Constants.AlignmentConstants.kMAX_SPEED_ANGLE);

    public static DoubleEntry kROTATION_TIMEOUT = alignTable
      .getDoubleTopic("ROTATION_TIMEOUT")
      .getEntry(Constants.AlignmentConstants.kROTATION_TIMEOUT);
    public static DoubleEntry kPOSITION_TIMEOUT = alignTable
      .getDoubleTopic("POSITION_TIMEOUT")
      .getEntry(Constants.AlignmentConstants.kPOSITION_TIMEOUT);
